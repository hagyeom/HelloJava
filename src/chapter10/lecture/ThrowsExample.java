...
public class ThrowsExample {
    public static void main(String[] args) throws ClassNotFoundException { // 메인 메서드에서 떠넘기게 되면 JVM에서 알아서 처리
        try {
            findClass();
    ...
    // 기본은 예외가 발생할 때 try-catch 블록으로 예외를 처리하는 것이 기본이긴 함
    // 부르마블의 복잡한 로직 속에서 어떤 예외가 발생하게 되면
